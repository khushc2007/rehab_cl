...
export default function MetricsPanel({mode,sel,onSelect,onStart,onStop,tremor}:{mode:Mode;sel:Ex;onSelect:(e:Ex)=>void;onStart:()=>void;onStop:()=>void;tremor:boolean}){
 ...
 return <aside className="w-[30vw] h-full bg-[#111] border-l border-[#1f1f1f] flex flex-col font-mono overflow-hidden" style={{padding:'clamp(12px,2.2vh,24px)',gap:'clamp(6px,1.5vh,16px)'}}>
